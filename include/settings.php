...
function http_security_options_page_html() {
	...
	switch( $tab ) {
		...
		case 'permissions-policy':
			include 'settings-permissions-policy-options.php';
			break;
		case 'htaccess':
	...
	jQuery(function() {
		...
		jQuery("#http_security_permissions_policy_flag").change(function() {
			if( jQuery('input[name=http_security_permissions_policy_flag]').is(':checked') ){
				jQuery(".http_security_permissions_policy_options").show();
			} else {
				jQuery(".http_security_permissions_policy_options").hide();
			}
		})
...
// 	register_setting( 'http-security', 'http_security_pkp_reportonly_flag' );
	...
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_flag' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_autoplay', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_autoplay_origin', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_camera', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_document_domain', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_encrypted_media', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_fullscreen', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_geolocation', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_microphone', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_midi', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_payment', 'http_security_options_sanitize_text_field' );
	register_setting( 'http-security-permissions-policy', 'http_security_permissions_policy_vr', 'http_security_options_sanitize_text_field' );
