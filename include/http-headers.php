...
function http_security_add_security_header() {
	...
	if ( get_option( 'http_security_permissions_policy_flag' ) ) {
		...
		if ( get_option( 'http_security_permissions_policy_autoplay' ) ) $header_string .= ' autoplay '. get_option( 'http_security_permissions_policy_autoplay' ).';';
		if ( get_option( 'http_security_permissions_policy_camera' ) ) $header_string .= ' camera '. get_option( 'http_security_permissions_policy_camera' ).';';
		if ( get_option( 'http_security_permissions_policy_document_domain' ) ) $header_string .= ' document-domain '. get_option( 'http_security_permissions_policy_document_domain' ).';';
		if ( get_option( 'http_security_permissions_policy_encrypted_media' ) ) $header_string .= ' encrypted-media '. get_option( 'http_security_permissions_policy_encrypted_media' ).';';
		if ( get_option( 'http_security_permissions_policy_fullscreen' ) ) $header_string .= ' fullscreen '. get_option( 'http_security_permissions_policy_fullscreen' ).';';
		if ( get_option( 'http_security_permissions_policy_geolocation' ) ) $header_string .= ' geolocation '. get_option( 'http_security_permissions_policy_geolocation' ).';';
		if ( get_option( 'http_security_permissions_policy_microphone' ) ) $header_string .= ' microphone '. get_option( 'http_security_permissions_policy_microphone' ).';';
		if ( get_option( 'http_security_permissions_policy_midi' ) ) $header_string .= ' midi '. get_option( 'http_security_permissions_policy_midi' ).';';
		if ( get_option( 'http_security_permissions_policy_payment' ) ) $header_string .= ' payment '. get_option( 'http_security_permissions_policy_payment' ).';';
		if ( get_option( 'http_security_permissions_policy_vr' ) ) $header_string .= ' vr '. get_option( 'http_security_permissions_policy_vr' ).';';
		header($header_string);
	}
